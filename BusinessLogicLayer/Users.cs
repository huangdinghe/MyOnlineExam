   ...
   public class Users
    {
        ...
        public bool CheckUser(int XUserID)
        {
            ...
            using (IDataReader DR = DB.RunProcGetReader("Proc_UsersDetail", Params))
            {
                if (!DR.Read())
                {
                    return false;
        ...
        {
            IDataParameter[] Params = new IDataParameter[5];
        ...
        {
            IDataParameter[] Params = new IDataParameter[6];
        ...
        {
            IDataParameter[] Params = new IDataParameter[4];
