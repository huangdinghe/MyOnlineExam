<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.Master" AutoEventWireup="true" CodeBehind="multiselect_mod.aspx.cs" Inherits="MyOnlineExam.teacher.multiselect_mod" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table cellspacing="0" style="font-size: 14px; font-family: Tahoma; border-collapse: collapse;" cellpadding="0" width="500" align="center" bgcolor="#eeeeee" border="1" bordercolor="gray">
		<tr>
		    <td align=center class="style1"><b>多选题信息</b>
		    </td>
		</tr>
		<tr height=22>
		    ...
		    <td align=center>
                <asp:GridView ID="GridView1" runat="server" Width=100% 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="multiselect_add.aspx?ID={0}" HeaderText="详细..." Text="详细..." />                                           
