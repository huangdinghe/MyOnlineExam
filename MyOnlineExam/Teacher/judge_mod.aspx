<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.Master" AutoEventWireup="true" CodeBehind="judge_mod.aspx.cs" Inherits="MyOnlineExam.teacher.judge_mod" %>
    ...
    <table cellspacing="0" style="font-size: 14px; font-family: Tahoma; border-collapse: collapse;" cellpadding="0" width="500" align="center" bgcolor="#eeeeee" border="1" bordercolor="gray">
		...
		<tr height=22>
		    <td align=center>考试科目：
                <asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="True" Width="200px" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged1">
                </asp:DropDownList>
            </td>
		</tr>
		<tr>
		    <td align=center>
                <asp:GridView ID="GridView1" runat="server" Width=100% 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="judge_add.aspx?ID={0}" HeaderText="详细..." Text="详细..." />                                           
