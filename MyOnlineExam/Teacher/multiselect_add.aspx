<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.Master" AutoEventWireup="true" CodeBehind="multiselect_add.aspx.cs" Inherits="MyOnlineExam.teacher.multiselect_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table cellspacing="0" style="font-size: 14px; font-family: Tahoma; border-collapse: collapse;" cellpadding="0" width="350" align="center" bgcolor="#eeeeee" border="1" bordercolor="gray">
		...
		<tr>
			<td align="center" nowrap width="60">选项A：</td>
			<td>
