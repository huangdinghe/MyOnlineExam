<%@ Page Title="" Language="C#" MasterPageFile="~/student/student.Master" AutoEventWireup="true"
    CodeBehind="score_query.aspx.cs" Inherits="MyOnlineExam.student.score_query" %>
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    DataKeyNames="PaperID" CellPadding="4" GridLines="None" ForeColor="#333333">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="考分">
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server"><%# Eval("Score") %></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="试卷总分">
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server"><%# Eval("SumMark") %></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="考试时间">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server"><%# Eval("ExamTime")%></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                        </asp:TemplateField>
                        <asp:HyperLinkField DataNavigateUrlFields="PaperID" 
                            DataNavigateUrlFormatString="answer.aspx?PaperID={0}" Text="答案" HeaderText="答案" />
                    </Columns>
