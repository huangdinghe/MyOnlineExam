...
{
    public partial class not_test : System.Web.UI.Page
    {
        ...
        protected void GridViewBind()
        {
            ...
            string GridView1Str = " select * from [dbo].[Paper] where [Paper].CourseID='" + int.Parse(ddlCourse.SelectedValue) + "' and PaperState=1 and PaperID not in(select PaperID from Score where UserID='" + Session["userID"] + "')";//查询该账号数据库是否存在
